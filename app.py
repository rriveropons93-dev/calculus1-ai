...
if st.session_state.modo is None:
    ...
    guest    = col1.button("Continue as Guest", use_container_width=True)
    register = col2.button("📝 Register",       use_container_width=True)
    ...
    if crear:
        if not first_name or not last_name or not student_id:
            ...
            st.error("That Student ID is already registered.")
        else:
            ...
            st.success(f"Account created! Username and password: **{student_id}**")
